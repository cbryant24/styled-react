...
//TODO: add styling for error message
export const Error = <P color="#e42d42" fontSize='.5em' ml="1em" ></P>
  ...
  return (
    <Div id="styled-react-field" {...styleBuildRemove(fieldStyle)}>
      ...
      >
        ...
        { errors.length >= 1 ? 
          <Ul ml="2rem" color={errorColor} fontSize="1rem">{handleErrorMessages(errors)}</Ul> 
          : ''
        }
      </FlexDiv>
      <Div
