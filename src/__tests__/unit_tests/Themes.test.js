...
describe('theme', () => {
  ...
  describe('custom theme', () => {
    beforeEach( async () => {
      console.log("IM A THEME", theme)
      component = mount(
      <ThemeProvider theme={theme}>
        <Div id="custom-theme-responsive" fontSizeModule={[1,2,3,4,'5rem']}>
          <Div
    ...
    it('has custom theme applied to font-size, line-height, letter-spacing, margin, color', () => {
      // expect(component).toMatchSnapshot();
      expect(component.find('#custom-theme-responsive').at(0)).toHaveStyleRule('font-size', '2.5rem');
      expect(component.find('.div-responsive').at(0)).toHaveStyleRule('margin-left', '.5rem');
      expect(component.find('.div-responsive').at(0)).toHaveStyleRule('margin-right', '.5rem');
      expect(component.find('.div-responsive').at(0)).toHaveStyleRule('padding-top', '.5rem');
      expect(component.find('.div-responsive').at(0)).toHaveStyleRule('padding-bottom', '.5rem');
      expect(component.find('.paragraph-responsive').at(0)).toHaveStyleRule('font-size', '12px');
      ...
      expect(component.find('.paragraph-responsive').at(0)).toHaveStyleRule('color', '#ffff00');
    });


    describe('responsive styles', () => {
      // beforeEach( async () => {
      //   component = mount(<ThemeProvider theme={theme}>
      //     <Div id="custom-theme-responsive" fontSizeModule={[1,2,3,4,'5rem']}>
      //       <Div
      //         className="div-responsive"
      //         mx={[1,2,3]} 
      ...
      // it('applys appropriate styling at min width 45px', () => {
      //   expect(component.find('#custom-theme-responsive').at(0)).toHaveStyleRule('font-size', '2rem', {
      //     media: 'screen and (min-width: 45px)'
      //   });
      //   expect(component.find('.div-responsive').at(0)).toHaveStyleRule('margin-left', '1rem', {
      //     media: 'screen and (min-width: 45px)'
      //   });
    ...
    //   it('applys appropriate styling at min width 40em', () => {
    ...
    //   it('applys appropriate styling at min width 50em', () => {
    ...
    //   it('applys appropriate styling at min width 60em', () => {
